///ndraw_sprite_part_ext(sprite, subimg, left, top, width, height x, y, xscale, yscale, colour, alpha)
///same as draw_sprite_part_ext but sends sprite to connected clients as well.
